!(function () {
    ...
    var I = function (t, e, n) {
        ...
        function v(t) {
            return (l = t), (c = setTimeout(m, e)), f ? b(t) : a;
        }
        function y(t) {
            var n = t - u;
        ...
        function g(t) {
            return (c = void 0), p && o ? b(t) : ((o = r = void 0), a);
        }
        function x() {
            var t = h(),
                n = y(t);
            if (((o = arguments), (r = this), (u = t), n)) {
                if (void 0 === c) return v(u);
                if (s) return clearTimeout(c), (c = setTimeout(m, e)), b(u);
            }
        ...
        (function (t) {
            ...
            function b() {
                ...
                return (
                    ...
                    n(u(t), '$el', D('span', { class: F }, [D('span', { class: L })])),
                    t.addEventListener(
                        'click',
                        I(function () {
                            t.toggle();
                ...
                (f = [
                    {
                        ...
                        value: function (t) {
                            t ||
                                ...
                                this.dark
                                    ? ((this.dataset.colorMode = 'dark'),
                                      (this.title = 'dark mode'),
                                      localStorage.setItem(A, String(+this.dark)))
                                    : (this.removeAttribute('data-color-mode'),
