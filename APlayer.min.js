                            ...
                            value: function (e) {
                                ...
                                (this.player.template.listOl.innerHTML += (0, a.default)({
                                    ...
                                    (this.player.template.listCurs[
                                        this.audios.length - 1
                                    ].style.backgroundColor = e.theme || this.player.options.theme),
                                    n &&
                                        ...
                                        this.on('play', function () {
                                            ...
                                            this.on('progress', function () {
                                                var t = e.audio.buffered.length
                                                    ? e.audio.buffered.end(
                                                          e.audio.buffered.length - 1
                                                      ) / e.duration
                                                    : 0;
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        if (
                                            (this.paused &&
                                                ((this.paused = !1),
                                                this.template.button.classList.remove(
                                                    'aplayer-play'
                                                ),
