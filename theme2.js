!(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        ? define(['exports'], t)
        : t(
              (e = 'undefined' != typeof globalThis ? globalThis : e || self).__inside__ ||
                  (self.__inside__ = {})
          );
})(this, function (e) {
    'use strict';
    var t = function () {
        ...
        c = {
            ...
            content_width: '640px',
            font: { base: i, logo: i, menu: i, heading: i, label: i, code: i, print: i },
            highlight: [
                '#ffffff',
                '#e0e0e0',
                '#f3f6f7',
    ...
    if (a) {
        document.addEventListener('inside:theme', function (e) {
            document.dispatchEvent(
                new CustomEvent('inside', { detail: { type: 'theme', data: e.detail } })
            );
        }),
            document.addEventListener('inside', function (e) {
                if (!a || 'theme' !== e.detail.type) return !1;
                u(e.detail.data);
            });
    ...
    function u(e) {
        var t = document.querySelector('style[is="theme"]'),
            ...
            r = window[o] || {};
        t ||
            ((t = document.createElement('style')).setAttribute('is', 'theme'),
            document.body.appendChild(t)),
            (r.theme = Object.assign({}, r.theme, e)),
            (r.color = [m(r.theme.sidebar_background).color || r.theme.accent_color].concat(
                m(r.theme.background).color || []
            )),
            (t.innerHTML = d(r.theme)),
            n && (n.content = r.color[r.color.length - 1]),
            localStorage.setItem(o, JSON.stringify({ theme: r.theme }));
    }
    function d(e) {
        if (!e) return '';
        var o = (function (e, t) {
                ...
                (n.content_width = _ ? _.value + _.unit : t.content_width),
                    Array.isArray(h)
                        ? ((n.highlight = h
                          ...
                          n.highlight.length < 16 && (n.highlight = t.highlight))
                        : (n.highlight = t.highlight);
                return n;
            })(e, c),
            i =
                (o.card_background.match(n) || o.card_background.match(r) || [])[0] ||
                o.foreground_color,
            a = g(o.accent_color);
        return (
            'html{' +
                        ...
                        if (Array.isArray(c))
                            c.forEach(function (e, t) {
                                var o,
                                    c = t.toString(16);
                                return (
                                    c.length < 2 && (c = '0' + c), n((((o = {})[c] = e), o), r, i)
                                );
                            });
                        else if ('object' == typeof c) n(c, r, i);
                        else {
                            var a = (o ? o + '_' : '') + i;
    ...
    function g(e, o) {
        if (((e = (e || '').trim()), n.test(e))) return t({ hex: e }, h(e));
        if (r.test(e)) {
            var i = e
                .match(r)
                .slice(1, 4)
            ...
            if (3 === i.length) return { hex: s.apply(null, i), r: i[0], g: i[1], b: i[2] };
        }
        return o ? t({ hex: o }, h(o)) : {};
    }
    function s(e, t, n) {
    ...
    function m(e) {
        ...
        var r = t.length - 1;
        return t[r] && n.test(t[r]) ? { color: t.pop(), image: t.join(' ') } : { image: e };
    }
    (e.css = d), Object.defineProperty(e, '__esModule', { value: !0 });
});
